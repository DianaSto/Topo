    ...
    <script>
        ...
        $(function () {
            ...
            if (("<%= start_date %>" == null||"<%= start_date %>" == ''||"<%= start_date %>" == 'undefined'||"<%= start_date %>" == '0')&&("<%= finish_date %>" == null||"<%= finish_date %>" == ''||"<%= finish_date %>" == 'undefined'||"<%= finish_date %>" == '0'))
            {
                ...
                label = "Ore lucrate de utilizator per proiecte";
            }
            else
            {
                url = "api/user/<%= id_user %>/<%= start_date %>/<%= finish_date %>";
                label = "Ore lucrate de utilizator per proiecte între <%= start_date %> și <%= finish_date %>";
            }
